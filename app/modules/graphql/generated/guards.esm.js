...
export var isContactGroupCondition = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isContactGroupCondition"')
...
export var isEnrichedContactGroupStatus = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isEnrichedContactGroupStatus"')
...
export var isContactGroupMembershipEnriched = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isContactGroupMembershipEnriched"')
...
export var isContactMembershipEnriched = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isContactMembershipEnriched"')
...
export var isEnrichedContactGroupMembershipList = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isEnrichedContactGroupMembershipList"')
...
export var isEnrichedContactMembershipList = function(obj) {
  if (!obj || !obj.__typename) throw new Error('__typename is missing in "isEnrichedContactMembershipList"')
