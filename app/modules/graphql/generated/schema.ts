...
export interface QueryRequest{
     ...
     * fieldSelector supports standard Kubernetes field selectors.
     */
    contactGroupMembershipsWithContacts?: [{namespace?: (Scalars['String'] | null),fieldSelector?: (Scalars['String'] | null),limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null)},EnrichedContactGroupMembershipListRequest] | EnrichedContactGroupMembershipListRequest
    /**
     * Lists ContactGroupMemberships in the given namespace, enriched with full
     * ContactGroup data for each membership. Resolves all contact groups in parallel.
     */
    contactMembershipsWithGroups?: [{namespace?: (Scalars['String'] | null),fieldSelector?: (Scalars['String'] | null),limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null)},EnrichedContactMembershipListRequest] | EnrichedContactMembershipListRequest
    /**
     * Batch-fetches User summaries by name. Fetches run in parallel; individual
     * lookup failures return null for that entry (filtered from the result).
     */
     ...
     * upstream pages until `limit` matches).
     */
    organizations?: [{limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null),search?: (Scalars['String'] | null)},OrganizationListRequest] | OrganizationListRequest
    /** Returns a single organization by name. */
    organization?: [{name: Scalars['String']},OrganizationRequest]
    /** Lists projects in an organization via its control plane. */
    organizationProjects?: [{orgName: Scalars['String'],limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null)},ProjectListRequest]
    /** Lists members and pending invitations for an organization. */
    organizationMembers?: [{orgName: Scalars['String']},OrgMemberRequest]
    /** Lists all projects the caller can access. */
    projects?: [{limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null),search?: (Scalars['String'] | null)},ProjectListRequest] | ProjectListRequest
    /** Returns a single project by name. */
...
export interface OrganizationRequest{
    ...
    /** Projects owned by this organization (via its control plane). */
    projects?: [{limit?: (Scalars['Int'] | null),cursor?: (Scalars['String'] | null)},ProjectListRequest] | ProjectListRequest
    __typename?: boolean | number
    __scalar?: boolean | number
    __alias?: {
...
export const isContactGroupCondition = (obj?: { __typename?: any } | null): obj is ContactGroupCondition => {
...
export const isEnrichedContactGroupStatus = (obj?: { __typename?: any } | null): obj is EnrichedContactGroupStatus => {
