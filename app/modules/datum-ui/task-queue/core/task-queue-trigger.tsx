    ...
    return (
      <Tooltip message="Tasks">
        <Button
          ...
          {...props}>
          <ListTodo className={cn('size-4', flash ? 'text-primary' : 'text-muted-foreground')} />
          ...
          {activeCount > 0 && (
            <Badge
              variant="default"
              className="bg-primary text-primary-foreground text-2xs absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full p-0 leading-none">
