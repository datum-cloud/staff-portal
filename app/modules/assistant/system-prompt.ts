...
const STATIC_SYSTEM_PROMPT = [
  ...
  'Query a compact activity timeline at platform scope. `queryActivityLogs` defaults to human write operations and excludes system accounts and get/list/watch noise.',
  'Investigation:',
  ...
  'Presentation:',
  '- One-sentence accomplishment, then a bullet timeline grouped by resource. Collapse identical failures (e.g. "Notes create failed 3× with 500: webhook …").',
