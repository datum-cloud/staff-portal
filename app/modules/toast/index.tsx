...
const Toast = (props: ToastProps) => {
  ...
  offset.current = React.useMemo(
    () => heightIndex * (gap ?? 14) + toastsHeightBefore,
  ...
  const icon =
    toast.icon ||
    (toastType ? icons?.[toastType as keyof typeof icons] : null) ||
  ...
  return (
    <li
      ...
      className={cn(
        ...
        classNames?.default,
        toastType ? classNames?.[toastType as keyof typeof classNames] : undefined,
        toastType ? toast?.classNames?.[toastType as keyof typeof toast.classNames] : undefined
      )}
      data-sonner-toast=""
      ...
      toast.icon !== null &&
      ((toastType ? icons?.[toastType as keyof typeof icons] !== null : false) || toast.icon) ? (
    ...
    if (typeof offset === 'number' || typeof offset === 'string') {
      ...
      ['top', 'right', 'bottom', 'left'].forEach((key) => {
        ...
        if (offset[offsetKey] === undefined) {
          ...
          styles[`${prefix}-${key}`] =
            typeof offset[offsetKey] === 'number' ? `${offset[offsetKey]}px` : offset[offsetKey];
        }
      });
    } else {
