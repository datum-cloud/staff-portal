...
import { MiloMainNav } from './milo-main-nav';
 ...
 * (center-left, with overflow scroll arrows), right cluster. Sticky to the top.
 * Below `md` the menu collapses into the hamburger sheet (MiloMobileMenu).
 */
export function MiloNavbar() {
  ...
  return (
    <header
      ...
      {/* Spacer pushes the right cluster to the edge on mobile, where the main
          nav (which carries flex-1 on desktop) is hidden. */}
