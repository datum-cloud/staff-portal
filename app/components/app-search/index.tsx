  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      <div className="bg-muted/25 hover:bg-muted/50 text-muted-foreground flex h-8 w-full items-center gap-1.5 rounded-md border px-2 md:w-40 lg:w-56 xl:w-64">
        ...
        />
        {!open && (
          <kbd className="bg-muted text-4xs pointer-events-none hidden h-5 shrink-0 items-center gap-1 rounded border px-1.5 font-mono font-medium select-none sm:flex">
